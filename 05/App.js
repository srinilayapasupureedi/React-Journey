...
"analytics": {
"context": "seo-data-bd793de5-f89c-43eb-ae1a-97540a398f86"
},
"cta": {
...
"availability": {
"nextCloseTime": "2025-06-25 23:30:00",
"opened": true
},
"badges": {},
"isOpen": true,
...
"gandalfRequest": "{\"sortAttribute\":\"relevance\",\"isFiltered\":false,\"queryId\":\"seo-data-bd793de5-f89c-43eb-ae1a-97540a398f86\",\"seoParams\":{\"apiName\":\"FoodHomePage\",\"brandId\":\"\",\"seoUrl\":\"www.swiggy.com\",\"pageType\":\"FOOD_HOME_PAGE\",\"businessLine\":\"FOOD\"}}",
"id": "meta_data",
"metaInfo": {
...
// ...existing code...
const Body=()=>{
  // Combine both restaurant arrays
  const topChains = resObj[0].card.card.gridElements.infoWithStyle.restaurants;
  const mainList = resObj[3].card.card.gridElements.infoWithStyle.restaurants;
  // Merge and remove duplicates by id
  const allRestaurantsMap = {};
  [...topChains, ...mainList].forEach(r => {
    allRestaurantsMap[r.info.id] = r.info;
  });
